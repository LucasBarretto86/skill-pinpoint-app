...
group :development, :test do
  ...
  # LUCAS: Basic testing framework configuration
  gem "rspec-rails"
...
group :development do
  ...
  # LUCAS: Basic gems to ensure code quality
  ...
  # LUCAS: I didn't want to add in this project, but since I feel like Survey models got a bit larger than I thought I decided to add
  gem "annotate"
end
